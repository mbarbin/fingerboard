...
let%expect_test "sort" =
  ...
  let ts =
    let table = Array.create ~len:25 [] in
    List.iter ts ~f:(fun t ->
      let number_of_semitons = Interval.number_of_semitons t in
      if 0 <= number_of_semitons && number_of_semitons <= 24
      then table.(number_of_semitons) <- t :: table.(number_of_semitons));
    Array.mapi table ~f:(fun i t -> i, t)
    |> Array.to_list
    |> List.filter ~f:(fun (_, q) -> not (List.is_empty q))
  ...
  List.iter ts ~f:(fun (i, canonical_interval, intervals) ->
    ...
    print_dyn
      (Dyn.Tuple
         [ Dyn.int i; Dyn.string canonical_interval; intervals |> Dyn.list Dyn.string ]));
  [%expect
    {|
    (0, "unison", [ "P1"; "d2" ])
...
let%expect_test "compute" =
  ...
  List.iter inputs ~f:(fun (from, to_) ->
    ...
    | Some interval ->
      ...
      if
        not
          (Option.equal Note.equal shift_up (Some to_)
           && Option.equal Note.equal shift_down (Some from))
      then
        Code_error.raise
          "Inconsistency"
          [ "from", from |> Note.to_dyn
          ; "to", to_ |> Note.to_dyn
  ...
  List.iter results ~f:(fun (number_of_semitons, interval, intervals) ->
    ...
    print_dyn
      (Dyn.Tuple
         [ number_of_semitons |> Dyn.int
         ; Interval.to_string interval |> Dyn.string
         ; Interval.name interval |> Dyn.string
         ; interval |> Interval.to_dyn
         ; intervals |> Dyn.list Dyn.string
         ]));
  [%expect
    {|
    (0,
     "P1",
     "unison",
     { number = Unison; quality = Perfect; additional_octaves = 0 },
     [ "Abbb1-Abbb1"
     ; "Abbb2-Abbb2"
     ; "Abbb3-Abbb3"
     ; "Abbb4-Abbb4"
    ...
    (1,
     "m2",
     "minor second",
     { number = Second; quality = Minor; additional_octaves = 0 },
     [ "Abb1-Bbbb1"
     ; "Abb2-Bbbb2"
     ; "Abb3-Bbbb3"
     ; "Abb4-Bbbb4"
    ...
    (12,
     "P8",
     "octave",
     { number = Unison; quality = Perfect; additional_octaves = 1 },
     [ "Abbb1-Abbb2"
     ; "Abbb2-Abbb3"
     ; "Abbb3-Abbb4"
     ; "Abb1-Abb2"
    ...
    (13,
     "P8 + dd3",
     "octave + doubly diminished third",
    ...
    (14,
     "P8 + AA1",
     "octave + doubly augmented unison",
    ...
    (15,
     "P8 + dd4",
     "octave + doubly diminished fourth",
    ...
    (16,
     "P8 + AA2",
     "octave + doubly augmented second",
    ...
    (17,
     "P8 + dd5",
     "octave + doubly diminished fifth",
    ...
    (18,
     "P8 + dd6",
     "octave + doubly diminished sixth",
    ...
    (19,
     "P8 + AA4",
     "octave + doubly augmented fourth",
    ...
    (20,
     "P8 + dd7",
     "octave + doubly diminished seventh",
    ...
    (25,
     "2 P8 + dd3",
     "2 octaves + doubly diminished third",
    ...
    (25,
     "P8 + AA7",
     "octave + doubly augmented seventh",
    ...
    (26,
     "2 P8 + AA1",
     "2 octaves + doubly augmented unison",
    ...
    (27,
     "2 P8 + dd4",
     "2 octaves + doubly diminished fourth",
    ...
    (28,
     "2 P8 + AA2",
     "2 octaves + doubly augmented second",
    ...
    (29,
     "2 P8 + dd5",
     "2 octaves + doubly diminished fifth",
    ...
    (30,
     "2 P8 + AA3",
     "2 octaves + doubly augmented third",
    ...
    (30,
     "2 P8 + dd6",
     "2 octaves + doubly diminished sixth",
    ...
    (31,
     "2 P8 + AA4",
     "2 octaves + doubly augmented fourth",
    ...
    (32,
     "2 P8 + dd7",
     "2 octaves + doubly diminished seventh",
    ...
    (33,
     "2 P8 + AA5",
     "2 octaves + doubly augmented fifth",
    ...
    (35,
     "2 P8 + AA6",
     "2 octaves + doubly augmented sixth",
    ...
    (37,
     "3 P8 + dd3",
     "3 octaves + doubly diminished third",
    ...
    (37,
     "2 P8 + AA7",
     "2 octaves + doubly augmented seventh",
    ...
    (38,
     "3 P8 + AA1",
     "3 octaves + doubly augmented unison",
    ...
    (39,
     "3 P8 + dd4",
     "3 octaves + doubly diminished fourth",
    ...
    (40,
     "3 P8 + AA2",
     "3 octaves + doubly augmented second",
    ...
    (41,
     "3 P8 + dd5",
     "3 octaves + doubly diminished fifth",
    ...
    (42,
     "3 P8 + AA3",
     "3 octaves + doubly augmented third",
    ...
    (42,
     "3 P8 + dd6",
     "3 octaves + doubly diminished sixth",
    ...
    (43,
     "3 P8 + AA4",
     "3 octaves + doubly augmented fourth",
