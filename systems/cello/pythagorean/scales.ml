...
let%expect_test "e_flat_major" =
  ...
  [%expect
    {|
    [ (IV, [ ("Eb2", "m3p"); ("F2", "4p") ])
    ; (III, [ ("G2", "0"); ("Ab2", "m2p"); ("Bb2", "m3p"); ("C3", "4p") ])
    ; (II,
       [ ("D3", "0")
       ; ("Eb3", "m2p")
       ; ("F3", "m3p")
...
let%expect_test "e_major" =
  ...
  [%expect
    {|
    [ (IV, [ ("E2", "M3p"); ("F#2", "A4p") ])
    ; (III, [ ("G#2", "A1p"); ("A2", "M2p"); ("B2", "M3p"); ("C#3", "A4p") ])
...
let%expect_test "f_sharp_major" =
  ...
  [%expect
    {|
    [ (IV, [ ("F#2", "A4p") ])
    ; (III, [ ("G#2", "A1p"); ("A#2", "A2p"); ("B2", "M3p"); ("C#3", "A4p") ])
    ; (II, [ ("D#3", "A1p"); ("E#3", "A2p"); ("F#3", "M3p"); ("G#3", "A4p") ])
    ; (I,
       [ ("A#3", "A1p")
       ; ("B3", "M2p")
...
let%expect_test "g_flat_major" =
  ...
  [%expect
    {|
    [ (IV, [ ("Gb2", "d5p") ])
    ; (III, [ ("Ab2", "m2p"); ("Bb2", "m3p"); ("Cb3", "d4p"); ("Db3", "d5p") ])
    ; (II, [ ("Eb3", "m2p"); ("F3", "m3p"); ("Gb3", "d4p"); ("Ab3", "d5p") ])
    ; (I,
       [ ("Bb3", "m2p")
       ; ("Cb4", "d3p")
