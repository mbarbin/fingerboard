...
let%expect_test "c_major" =
  ...
  [%expect
    {|
    [ (IV, [ ("C2", "0"); ("D2", "M2-e19"); ("E2", "M3-e19"); ("F2", "4-e19") ])
    ; (III, [ ("G2", "0"); ("A2", "M2-e19"); ("B2", "M3-e19"); ("C3", "4-e19") ])
    ; (II, [ ("D3", "0"); ("E3", "M2-e19"); ("F3", "m3-e19"); ("G3", "4-e19") ])
    ; (I,
       [ ("A3", "0")
       ; ("B3", "M2-e19")
       ; ("C4", "m3-e19")
...
let%expect_test "d_major" =
  ...
  [%expect
    {|
    [ (IV, [ ("D2", "M2-e19"); ("E2", "M3-e19"); ("F#2", "A4-e19") ])
    ; (III,
       [ ("G2", "0"); ("A2", "M2-e19"); ("B2", "M3-e19"); ("C#3", "A4-e19") ])
    ; (II, [ ("D3", "0"); ("E3", "M2-e19"); ("F#3", "M3-e19"); ("G3", "4-e19") ])
    ; (I,
       [ ("A3", "0")
       ; ("B3", "M2-e19")
       ; ("C#4", "M3-e19")
...
let%expect_test "e_flat_major" =
  ...
  [%expect
    {|
    [ (IV, [ ("Eb2", "m3-e19"); ("F2", "4-e19") ])
    ; (III,
       [ ("G2", "0"); ("Ab2", "m2-e19"); ("Bb2", "m3-e19"); ("C3", "4-e19") ])
    ; (II,
       [ ("D3", "0")
       ; ("Eb3", "m2-e19")
       ; ("F3", "m3-e19")
...
let%expect_test "f_major" =
  ...
  [%expect
    {|
    [ (IV, [ ("F2", "4-e19") ])
    ; (III, [ ("G2", "0"); ("A2", "M2-e19"); ("Bb2", "m3-e19"); ("C3", "4-e19") ])
    ; (II, [ ("D3", "0"); ("E3", "M2-e19"); ("F3", "m3-e19"); ("G3", "4-e19") ])
    ; (I,
       [ ("A3", "0")
       ; ("Bb3", "m2-e19")
...
let%expect_test "a_major" =
  ...
  [%expect
    {|
    [ (III, [ ("A2", "M2-e19"); ("B2", "M3-e19"); ("C#3", "A4-e19") ])
    ; (II,
       [ ("D3", "0"); ("E3", "M2-e19"); ("F#3", "M3-e19"); ("G#3", "A4-e19") ])
    ; (I,
       [ ("A3", "0")
       ; ("B3", "M2-e19")
       ; ("C#4", "M3-e19")
...
let%expect_test "b_flat_major" =
  ...
  [%expect
    {|
    [ (III, [ ("Bb2", "m3-e19"); ("C3", "4-e19") ])
    ; (II, [ ("D3", "0"); ("Eb3", "m2-e19"); ("F3", "m3-e19"); ("G3", "4-e19") ])
    ; (I,
       [ ("A3", "0")
       ; ("Bb3", "m2-e19")
       ; ("C4", "m3-e19")
