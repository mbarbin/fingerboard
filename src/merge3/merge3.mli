(*_***************************************************************************)
(*_  fingerboard-merge3 - Myers shortest-edit-script computation             *)
...
(*_ Notice: This file was vendored from gazagnaire/ocaml-merge3 (the [Merge3]
  module, [lib/merge3.mli]) as documented in [vendor.json] and the project's
  root [NOTICE.md].
